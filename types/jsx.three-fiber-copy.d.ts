...
export type CapsuleGeometryProps = BufferGeometryNode<
  THREE.CapsuleBufferGeometry,
  typeof THREE.CapsuleBufferGeometry
>;
...
export type BufferAttributeProps = Node<
  THREE.BufferAttribute,
  typeof THREE.BufferAttribute
>;
export type Float16BufferAttributeProps = Node<
...
>;
export type Float64BufferAttributeProps = Node<
  THREE.Float64BufferAttribute,
  typeof THREE.Float64BufferAttribute
>;
export type Int8BufferAttributeProps = Node<
  THREE.Int8BufferAttribute,
  typeof THREE.Int8BufferAttribute
>;
export type Int16BufferAttributeProps = Node<
  THREE.Int16BufferAttribute,
  typeof THREE.Int16BufferAttribute
>;
export type Int32BufferAttributeProps = Node<
  THREE.Int32BufferAttribute,
  typeof THREE.Int32BufferAttribute
>;
export type Uint8BufferAttributeProps = Node<
  THREE.Uint8BufferAttribute,
  typeof THREE.Uint8BufferAttribute
>;
export type Uint16BufferAttributeProps = Node<
  THREE.Uint16BufferAttribute,
  typeof THREE.Uint16BufferAttribute
>;
export type Uint32BufferAttributeProps = Node<
